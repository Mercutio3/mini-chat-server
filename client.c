...
//#define DEBUG
//#define INSTRUCTIONS //Print instructions every time a message is sent/received
//#define LOCAL_EXIT //Client exits immediately when using /exit instead of waiting for server to close connection
