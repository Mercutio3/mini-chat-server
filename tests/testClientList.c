...
int main(void) {
    printf("Starting clientList tests...\n");
    ...
    assert(head != NULL && head->fd == 3 && head->next != NULL && head->next->fd == 5 &&
           head->next->next == NULL);
    head = addClient(head, 7);
    assert(head != NULL && head->fd == 3 && head->next != NULL && head->next->fd == 5 &&
           head->next->next != NULL && head->next->next->fd == 7 && head->next->next->next == NULL);
    ...
    assert(head != NULL && head->fd == 3 && head->next != NULL && head->next->fd == 7 &&
           head->next->next == NULL);
    ...
    assert(head != NULL && head->fd == 10 && head->next != NULL && head->next->fd == 20 &&
           head->next->next == NULL);
